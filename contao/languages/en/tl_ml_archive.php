...
$lang['jumpTo'][0] = 'Redirect page after creation';
$lang['jumpTo'][1] = 'Select the page to which the user should be redirected after creating a product. If it is a product reader page, the alias of the new product is appended.';
